...
router.route('/weather/:latitude/:longitude')
  .get(function(req,res,next) {
    var url = 'https://api.wunderground.com/api/1b72f368a909a00d/conditions/q/' + req.params.latitude + ',' + req.params.longitude + '.json'
    request.get({url: url}, function(err, response, data) {
      res.send(JSON.parse(response.body));
    })
  })
...
router.route('/astronomy/:latitude/:longitude')
    .get(function(req,res,next) {
      var url = 'http://api.wunderground.com/api/1b72f368a909a00d/astronomy/q/' + req.params.latitude + ',' + req.params.longitude + '.json'
      request.get({url: url}, function(err, response, data) {
        res.send(JSON.parse(response.body));
      })
    })
...
router.route('/hourly/:latitude/:longitude')
    .get(function(req,res,next) {
      var url = 'http://api.wunderground.com/api/1b72f368a909a00d/hourly/q/' + req.params.latitude + ',' + req.params.longitude + '.json'
        request.get({url: url}, function(err, response, data) {
          res.send(JSON.parse(response.body));
        })
      })
...
router.route('/forecast/:latitude/:longitude')
    .get(function(req,res,next) {
      var url = 'http://api.wunderground.com/api/1b72f368a909a00d/forecast/q/' + req.params.latitude + ',' + req.params.longitude + '.json'
        request.get({url: url}, function(err, response, data) {
          res.send(JSON.parse(response.body));
        })
      })
...
router.route('/tendayforecast/:latitude/:longitude')
    .get(function(req,res,next) {
      var url = 'http://api.wunderground.com/api/1b72f368a909a00d/forecast10day/q/' + req.params.latitude + ',' + req.params.longitude + '.json'
        request.get({url: url}, function(err, response, data) {
          res.send(JSON.parse(response.body));
        })
      })
...
router.route('/alerts/:latitude/:longitude')
    .get(function(req,res,next) {
      var url = 'http://api.wunderground.com/api/1b72f368a909a00d/alerts/q/' + req.params.latitude + ',' + req.params.longitude + '.json'
        request.get({url: url}, function(err, response, data) {
          res.send(JSON.parse(response.body));
        })
      })
...
router.route('/tide')
  .get(function(req,res,next) {
    var url = 'http://api.wunderground.com/api/1b72f368a909a00d/tide/q/29464.json'
      request.get({url: url}, function(err, response, data) {
        res.send(JSON.parse(response.body));
      })
    })
